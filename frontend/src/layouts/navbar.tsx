    ...
    <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-border bg-surface/80 px-4 backdrop-blur-xl lg:px-6">
      ...
      <div className="relative hidden max-w-md flex-1 md:block">
        ...
        <input
          ...
          className={cn(
            "h-10 w-full rounded-xl border border-border bg-canvas/80 pr-3 pl-10 text-sm",
          ...
          <AnimatePresence>
            {profileOpen ? (
              <motion.div
                ...
                className="absolute right-0 mt-2 w-52 overflow-hidden rounded-xl border border-border bg-surface-elevated p-1 shadow-lift"
              >
                <Link
                  to="/settings"
                  onClick={() => setProfileOpen(false)}
                  className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm text-foreground-soft hover:bg-canvas"
                >
                ...
                <button
                  type="button"
                  className="flex w-full items-center gap-2 rounded-lg px-3 py-2 text-sm text-danger hover:bg-canvas"
                >
